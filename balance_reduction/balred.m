...
for t = 1:timesteps
    x_new = fsys.A*x_old + fsys.B*U + H10_gust(:,t);
    y = fsys.C * x_new;
    fplunge(t,1) = y(1,1);
    fpitch(t,1) = y(2,1);
    fbend(t,1) = y(3,1);
...
plot(time(:,1),rplunge(:,2), "r--", "DisplayName","18 states", "LineWidth", 3);
grid on;
%legend();
xlabel("time (s)")
ylabel("\Delta h (m)")
...
plot(time(:,1),rpitch(:,2)/pi*180, "r--", "DisplayName","18 states", "LineWidth", 3);
grid on;
%legend();
xlabel("time (s)")
...
plot(time(:,1),rbend(:,2)*200, "r--", "DisplayName","18 states", "LineWidth", 3);
grid on;
legend();
xlabel("time (s)")
...
plot(time(:,1),rplunge(:,2), "DisplayName", "H = 10m", "LineWidth", 3);
plot(time(:,1),rplunge(:,3), "DisplayName", "H = 15m", "LineWidth", 3);
plot(time(:,1),rplunge(:,4), "DisplayName", "H = 20m", "LineWidth", 3);
grid on;
%legend();
xlabel("time (s)")
ylabel("\Delta h (m)")
...
plot(time(:,1),rpitch(:,2)/pi*180, "DisplayName", "H = 10m", "LineWidth", 3);
plot(time(:,1),rpitch(:,3)/pi*180, "DisplayName", "H = 15m", "LineWidth", 3);
plot(time(:,1),rpitch(:,4)/pi*180, "DisplayName", "H = 20m", "LineWidth", 3);
grid on;
%legend();
xlabel("time (s)")
ylabel("\Delta \alpha (deg)")
...
plot(time(:,1),rbend(:,2)*200, "DisplayName", "H = 10m", "LineWidth", 3);
plot(time(:,1),rbend(:,3)*200, "DisplayName", "H = 15m", "LineWidth", 3);
plot(time(:,1),rbend(:,4)*200, "DisplayName", "H = 20m", "LineWidth", 3);
grid on;
legend();
xlabel("time (s)")
ylabel("\Delta z_{tip} (% b/2)")
