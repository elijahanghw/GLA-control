...
class Agent:
    def __init__(self, env, nodes=128, a_lr=1e-4, c_lr=1e-3, gamma=0.99, tau=1e-2, mem_size=50000):
        ...
        self.actor = Actor(self.num_states, nodes, self.num_actions)
        self.actor_target = Actor(self.num_states, nodes, self.num_actions)

        self.critic = Critic(self.num_states + self.num_actions, nodes, self.num_actions)
        self.critic_target = Critic(self.num_states + self.num_actions, nodes, self.num_actions)
