...
plunge_h10_close = load("plunge_h10_close.mat").plunge_close;
plunge_h15_open = load("plunge_h15_open.mat").plungehat_open;
plunge_h15_close = load("plunge_h15_close.mat").plunge_close;
plunge_h20_open = load("plunge_h20_open.mat").plungehat_open;
plunge_h20_close = load("plunge_h20_close.mat").plunge_close;

pitch_h10_open = load("pitch_h10_open.mat").pitchhat_open;
pitch_h10_close = load("pitch_h10_close.mat").pitch_close;
pitch_h15_open = load("pitch_h15_open.mat").pitchhat_open;
pitch_h15_close = load("pitch_h15_close.mat").pitch_close;
pitch_h20_open = load("pitch_h20_open.mat").pitchhat_open;
pitch_h20_close = load("pitch_h20_close.mat").pitch_close;
